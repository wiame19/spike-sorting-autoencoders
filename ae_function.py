...
# Voir ae_function_cb.py pour leur définition et leur documentation.
from ae_function_cb import (
    create_dossier,
    create_dossier_article,
    save_figure,
    save_model,
    load_model,
    separation_data,
    decomposition_ondelettes,
...
def run_autoencoder(data_type, simulation_number, data, labels, gt_labels, index, ae_type, ae_layers, code_size, output_activation, loss_function, scale, shuff=True, noNoise=False, nr_epochs=100,
    ...
    if data_type == "m0":
        ...
        spikes, labels, signal = ds.get_dataset_simulation(simNr=simulation_number, align_to_peak=2)
    else:
        spikes = np.array(data)
    ...
    if ae_type == "shallow":
        ...
        ae_layers = [60,40,20] #pour les simulations
